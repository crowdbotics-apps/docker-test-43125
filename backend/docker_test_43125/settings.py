"""
Django settings for docker_test_43125 project.
...
ROOT_URLCONF = 'docker_test_43125.urls'
...
WSGI_APPLICATION = 'docker_test_43125.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "docker_test_43125 API",
    "DESCRIPTION": "API documentation for docker_test_43125 App",
    "VERSION": "v1",
}
